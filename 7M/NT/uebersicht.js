  ...
  const THEMEN = [
    {
      ...
      module: [
        ...
        {titel: "Windkraft: Bewegte Luft erzeugt Strom",
         text: "Wie aus Wind elektrische Energie wird: Rotor, Generator und Windpark."},
        {titel: "Windkraft – pro und contra",
         text: "Vorteile und Nachteile von Windrädern abwägen und eine eigene Meinung begründen."},
