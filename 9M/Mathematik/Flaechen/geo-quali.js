...
`, "0 0 280 240");
  ...
  // Jede Zeile darf mit einem Status-Marker beginnen: [ok] grün (richtig),
  // [fehler] rot (falsch), [fehlt] orange (fehlt noch). Ohne Marker richtet
  // sich die Farbe nach dem Gesamtstatus (kind).
